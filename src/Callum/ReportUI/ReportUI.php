...
use Callum\ReportUI\event\Listener;
use Callum\ReportUI\event\PlayerReportEvent;
use Callum\ReportUI\event\ReportProcessedEvent;
use Callum\ReportUI\task\SaveTask;
...
class ReportUI extends PluginBase{
    ...
    public function onLoad(){
        ...
        if($this->getConfig()->get("check-update", true)){
            ...
            try{
                if(($version = (new PluginDescription(file_get_contents("https://raw.githubusercontent.com/Callum/ReportUI/master/plugin.yml")))->getVersion()) != $this->getDescription()->getVersion()){
    ...
    public function onEnable(){
        ...
        $this->getServer()->getLogger()->info(TextFormat::AQUA . 'ReportUI enabled. ' . TextFormat::GRAY . 'Made by Callum with ' . TextFormat::RED . "\xe2\x9d\xa4");
    }
